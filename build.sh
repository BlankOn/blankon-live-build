...
## Build
sudo lb clean
sudo lb config --keyring-packages blankon-archive-keyring --debootstrap-options "--exclude=usr-is-merged --keyring=/usr/share/keyrings/blankon-archive-keyring.gpg"
