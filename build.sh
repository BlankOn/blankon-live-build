...
## Build
sudo lb clean
sudo lb config --keyring-packages blankon-archive-keyring --debootstrap-options "--debootstrap-script /usr/share/debootstrap/scripts/sid --exclude=usrmerge --keyring=/usr/share/keyrings/blankon-archive-keyring.gpg"
